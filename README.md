...
1) Preprocesamiento: Se seleccionan los valores únicos para el dataset de frecuencia de sampleo, profundidad de bits y número de canales. En esta versión, se utilizará un resampleo a 22050 Hz a partir de una ventana de Kaiser con \beta=15 y una frecuencia de cutoff de 0.95 de la frecuencia de Nyquist correspondiente.
